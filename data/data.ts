...
const DataObject: ISetData = {
  cover: {
    description:
      'THis is a description of the description. It should be short and impacted because this is not all of the texts for description of a cover page.',
    initial:
