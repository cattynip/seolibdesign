...
const MagazineProjectData: IProjectData<IMagazineData> = {
  title: 'Magazine',
  description:
    'This project is to develop and design a perfect magazine that my client wants to make. For this, I made 3 initial, 2 intermediate and last one final drafts for each section which are the Cover, Middle(Main) and Back pages.',
  shortDescription:
